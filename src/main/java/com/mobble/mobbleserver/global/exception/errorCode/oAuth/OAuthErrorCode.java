...
public enum OAuthErrorCode implements ErrorCode {
    ...
    MISSING_TOKEN_VERSION("Token Version 이 누락되었습니다.", HttpStatus.UNAUTHORIZED),
    INVALID_TOKEN_VERSION("Token Version 값이 올바르지 않습니다.", HttpStatus.UNAUTHORIZED),
    INVALID_TOKEN_SUBJECT("Token Subject 값이 올바르지 않습니다.", HttpStatus.UNAUTHORIZED);
